...
it('Conflicting file blocking directory is not overwritten without overwrite flag', () => {
	fs.mkdirSync('target');
...
it('Conflicting directory blocking file is not overwritten without overwrite flag', () => {
	fs.mkdirSync('target');
